...
This package contains the implementation of some example Fragment generators, used to demonstrate the capabilities of the _artdaq_ framework.

See https://github.com/art-daq/artdaq-demo/wiki for getting-started instructions.
