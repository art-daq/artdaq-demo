...
prods="\
mpich v3_2_0 -f Linux64bit+2.6-2.12 -z ${productdir} -q ${basequal2}:${build_type}
xmlrpc_c v1_39_07 -f Linux64bit+2.6-2.12 -z ${productdir} -q ${basequal2}:${build_type}"
...
TRACE/v3_06_07/TRACE-3.06.07-slf6-x86_64-e7.tar.bz2"
